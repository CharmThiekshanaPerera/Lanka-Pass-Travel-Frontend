...
const STEPS = [
  ...
  },
  {
    ...
    gradient: "from-secondary to-palm",
  ...
  },
  {
    ...
    gradient: "from-sunset to-accent",
    features: ["Dashboard access", "Secure payments", "Analytics"]
  },
];

const STATS = [
  { value: "98%", label: "Success Rate", gradient: "from-ocean to-secondary" },
  { value: "24h", label: "Fast Review", gradient: "from-secondary to-palm" },
  { value: "4.9★", label: "Partner Rating", gradient: "from-palm to-ocean" },
  { icon: Users, label: "5,000+ Partners", color: "text-accent" },
];
...
const HowItWorks = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="how-it-works"
      className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-gradient-to-b from-background via-white to-background/50"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 lg:mb-24">
          {/* Subtitle Badge */}
          <div
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-blue-200/50 shadow-sm mb-6 transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'
              }`}
          ...
          {/* Main Heading */}
          <h1
            className={`text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 transition-all duration-700 delay-100 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'
              }`}
          >
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground/80 to-foreground">
              Start Your Journey in
            </span>
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-ocean via-secondary to-palm animate-gradient">
              4 Simple Steps
            </span>
          </h1>
          ...
          {/* Description */}
          <p
            className={`text-lg md:text-xl text-slate-600 leading-relaxed max-w-3xl mx-auto transition-all duration-700 delay-200 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'
              }`}
          >
          ...
          {/* Stats 
          <div
            className={`flex flex-wrap justify-center gap-8 md:gap-12 mt-10 transition-all duration-700 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}
            role="region"
        ...
        <div className="relative">
                ...
                >
                  ...
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
                    <div className="relative">
                      {/* Glow Effect */}
                      <div
                        className={`absolute -inset-3 rounded-full blur-md transition-all duration-500 ${isActive
                      ...
                      {/* Number Circle */}
                      <div
                        className={`relative w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg transition-all duration-300 ${isActive
                          ? 'scale-110'
                  ...
                  <div className="relative pt-8">
                    {/* Card Glow */}
                    <div
                      className={`absolute -inset-1 rounded-2xl blur-lg transition-all duration-500 ${isActive
                    ...
                    <div
                      className={`relative rounded-xl p-6 border transition-all duration-300 overflow-hidden ${isActive
                    ...
                    >
                      ...
                      <div className="relative mb-5">
                        <div
                          className={`absolute inset-0 rounded-xl blur-md transition-all duration-500 ${isActive ? `bg-gradient-to-br ${step.gradient} opacity-20` : 'opacity-0'
                            }`}
                        />
                        <div
                          className={`relative w-16 h-16 rounded-xl flex items-center justify-center transition-all duration-300 ${isActive ? 'scale-105' : ''
                      ...
                      <div className="relative space-y-4">
                        ...
                        <header>
                          ...
                          <h3
                            className={`text-xl font-bold mb-2 transition-colors duration-300 ${isActive
                          ...
                          <ul className="space-y-1.5">
                            {step.features.map((feature, idx) => (
                              <li key={idx} className="flex items-center gap-2 text-slate-700">
                                <div
                                  className={`w-4 h-4 rounded-full flex items-center justify-center transition-all duration-300 ${isActive
                        ...
                        {/* Highlight Badge */}
                        <div
                          className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full transition-all duration-300 ${isActive
                        ...
                        >
                          <div
                            className={`w-1.5 h-1.5 rounded-full animate-pulse ${isActive
                              ? `bg-gradient-to-br ${step.gradient}`
                              : 'bg-slate-400'
                              }`}
                            aria-hidden="true"
                    ...
                    {index < STEPS.length - 1 && (
                      <div className="hidden lg:block absolute top-1/2 -right-3 z-10">
                        <div className="relative">
                          <div
                            className={`absolute inset-0 bg-gradient-to-r ${step.gradient} rounded-full blur-sm transition-all duration-500 ${isActive ? 'opacity-20' : 'opacity-0'
                              }`}
                          />
                          <div
                            className={`relative p-1.5 rounded-full bg-white shadow-sm border border-slate-100 transition-all duration-300 ${isActive ? 'scale-110' : ''
                              }`}
                            aria-hidden="true"
                          >
                            <ArrowRight
          ...
          {/* CTA Section */}
          <div
            className={`mt-20 text-center transition-all duration-700 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}
          >
            <div className="max-w-2xl mx-auto">
              <div className="relative inline-block">
                {/* Floating Particles */}
                <div className="absolute -top-3 -left-3 w-6 h-6 bg-gradient-to-r from-ocean to-secondary rounded-full animate-bounce" />
                <div className="absolute -top-1 -right-4 w-5 h-5 bg-gradient-to-r from-secondary to-palm rounded-full animate-bounce delay-200" />
                <div className="absolute -bottom-4 left-6 w-4 h-4 bg-gradient-to-r from-accent to-ocean rounded-full animate-bounce delay-400" />

                <button
                  className="group relative px-10 py-4 rounded-xl bg-gradient-to-r from-ocean via-secondary to-palm text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-95 overflow-hidden"
                ...
                >
                  ...
                  {/* Success Rate Badge */}
                  <div
                    className="absolute -top-1 -right-1 px-2 py-1 rounded-full bg-gradient-to-r from-accent to-secondary text-white text-xs font-bold shadow-sm"
