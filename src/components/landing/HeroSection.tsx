  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-background pt-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-30">
        <div className="max-w-5xl mx-auto text-center relative min-h-[360px] sm:min-h-[420px] md:min-h-[520px]">
          ...
          {slides.map((slide, index) => {
            ...
            return (
              ...
              >
                ...
                <h1 className="font-display text-3xl sm:text-4xl md:text-6xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 sm:mb-8 leading-[1.1] drop-shadow-2xl">
                  {slide.title}
                </h1>

                {/* High-Visibility Subheadline */}
                <p className="text-base sm:text-lg md:text-2xl text-white font-medium mb-8 sm:mb-12 leading-relaxed max-w-3xl mx-auto drop-shadow-lg">
                  {slide.subtitle}
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                  <Link to="/onboarding" className="w-full sm:w-auto">
                    <button
                      className="w-full group relative px-8 sm:px-10 py-4 sm:py-5 rounded-2xl bg-primary text-white font-bold text-base sm:text-lg transition-all hover:shadow-glow hover:scale-[1.02] active:scale-95 shadow-xl"
                    >
                  ...
                  <a href="#how-it-works" className="w-full sm:w-auto">
                    <button className="w-full group px-6 sm:px-8 py-4 sm:py-5 rounded-2xl bg-white/20 backdrop-blur-lg border border-white/40 text-white font-bold text-base sm:text-lg hover:bg-white/30 transition-all flex items-center justify-center gap-3 shadow-xl">
